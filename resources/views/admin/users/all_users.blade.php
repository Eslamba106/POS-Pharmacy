    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            ...
            <div class="col text-right">
                <a href="{{ route($main_route .'.user_management.create') }}" class="btn btn-circle btn-info">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                        href="{{ route($main_route .'.user_management.view', $user->id) }}"
                                    ...
                                    <a class="btn btn-soft-secondary btn-icon btn-circle btn-sm"
                                        href="{{ route($main_route .'.user_management.edit',  $user->id) }}"
                                    ...
                                    <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                        data-href="{{ route($main_route .'.user_management.delete', $user->id) }}"
...
@section('script')
    <script type="text/javascript">
        ...
        function update_user_status(el) {
            ...
            $.post('{{ route($main_route .'.user_management.update_status') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
        ...
        function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "{{ route($main_route .'.bulk-user-delete') }}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
